/**
 * Standalone Render Test Script
 *
 * This script renders the few-shot carousel example to PNG images
 * WITHOUT requiring API keys, Supabase, or any external services.
 *
...
// ─── Hardcoded carousel data (from few-shot example) ─────────────
const CAROUSEL_DATA = {
    ...
    slides: [
        {
            ...
            bg_color: "#050505",
            bg_gradient: "linear-gradient(180deg, #050505 0%, #0a1a0f 100%)",
            text_color: "#ffffff",
            accent_color: "#00ff9d",
        ...
        },
        {
            ...
            role: "content",
            headline: "Gamma AI",
            body_markdown: "**O que faz:** Cria apresentações incríveis em segundos.\n\n- Slides prontos\n- Design profissional\n- Exporta para PDF",
            body: null,
            layout: "split-left",
            image: {
                type: "placeholder",
                prompt: "Futuristic holographic presentation slides floating in dark space",
                url: null
            },
            bg_color: "#050505",
            bg_gradient: null,
        ...
        },
        {
            ...
            body_markdown: "**O que faz:** Pesquisa com IA que cita as fontes.\n\n- Mais preciso que o Google\n- Respostas com referências\n- Sem ads",
            body: null,
            layout: "split-right",
            image: {
                type: "placeholder",
                prompt: "AI search engine interface with glowing data nodes, dark UI",
                url: null
            },
            bg_color: "#050505",
            bg_gradient: null,
        ...
        },
        {
            ...
            role: "content",
            headline: "Notion AI",
            body_markdown: "**O que faz:** Organiza seu segundo cérebro.\n\n- Resumos automáticos\n- Banco de dados inteligente\n- Templates prontos",
            body: null,
            layout: "split-left",
            image: {
                type: "placeholder",
                prompt: "Minimalist dark workspace with floating organized data blocks, neon outlines",
                url: null
            },
            bg_color: "#050505",
            bg_gradient: null,
        ...
        },
        {
            ...
            role: "content",
            headline: "ElevenLabs",
            body_markdown: "**O que faz:** Clona vozes e gera áudio realista.\n\n- Narração profissional\n- Clone de voz em minutos\n- 29 idiomas",
            body: null,
            layout: "split-right",
            image: {
                type: "placeholder",
                prompt: "Sound wave visualization with AI avatar speaking, neon green frequencies on dark background",
                url: null
            },
            bg_color: "#050505",
            bg_gradient: null,
        ...
        },
        {
            ...
            bg_color: "#050505",
            bg_gradient: "linear-gradient(180deg, #0a1a0f 0%, #050505 100%)",
            text_color: "#ffffff",
            accent_color: "#00ff9d",
            font_headline: "Inter Tight",
            font_body: "Inter",
...
const OUTPUT_DIR = join(process.cwd(), 'output', 'test-render');

async function main() {
    console.log('🚀 ShadowFeed Render Test');
